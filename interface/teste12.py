...
from PyQt5.QtWidgets import QFileDialog
from PyQt5.QtMultimediaWidgets import QMediaPlayerControl
...
class JanelaTerceiraTela(QDialog):
    ...
    def carregar_audio(self):
        ...
        if file_dialog.exec_():
            ...
            # Criar um player de áudio para reproduzir o áudio carregado
            player = QMediaPlayer()
            player.setMedia(QMediaContent(QUrl.fromLocalFile(caminho_arquivo)))

            # Criar um widget para controlar a reprodução de áudio
            media_control = QMediaPlayerControl(player)
            ...
            reproduzir_button.clicked.connect(player.play)
            ...
            # Adicionar o widget de controle de mídia ao layout
            layout.addWidget(media_control)
