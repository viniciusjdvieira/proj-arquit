...
class JanelaQuartaTela(QDialog):
    ...
    def initUI(self):
        ...
        group_layout.addWidget(close_button, 0, 0)

        # Botão de maximizar
        maximize_button = QPushButton()
        maximize_button.setIcon(QIcon("maximiza.png"))
        maximize_button.clicked.connect(self.showMaximized)
        group_layout.addWidget(maximize_button, 0, 1)

        # Botão de minimizar
        minimize_button = QPushButton()
        minimize_button.setIcon(QIcon("minimiza.png"))
        minimize_button.clicked.connect(self.showMinimized)
        group_layout.addWidget(minimize_button, 0, 2)
