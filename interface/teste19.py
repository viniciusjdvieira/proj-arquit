...
from PyQt5.QtCore import QUrl, QAudioFormat
import os
...
class JanelaTerceiraTela(QDialog):
    ...
    def init_ui(self):
        ...
        # Configurações do gravador de áudio
        self.audio_recorder = QAudioRecorder()
        format_settings = self.audio_recorder.defaultAudioSettings()
        format_settings.setSampleRate(22050)
        format_settings.setSampleSize(16)
        format_settings.setChannelCount(1)  # Configuração para mono
        self.audio_recorder.setAudioSettings(format_settings)
    ...
    def iniciar_gravacao(self):
        self.audio_recorder.setOutputLocation(QUrl.fromLocalFile(f"grav_{self.numero_matricula}.wav"))
