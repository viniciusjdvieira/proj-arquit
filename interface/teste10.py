...
class JanelaTerceiraTela(QDialog):
    ...
    def gravar_audio(self):
        ...
        # Exemplo de uso:
        # caminho_arquivo = "caminho_para_salvar_o_arquivo.wav"  # Substitua pelo caminho real de salvamento
        # audio_util.gravar_audio(caminho_arquivo)

        # Após a gravação, abrir a terceira tela novamente para reproduzir o áudio gravado
        self.initUI()
