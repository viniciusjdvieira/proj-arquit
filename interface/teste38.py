...
class JanelaQuartaTela(QDialog):
    ...
    def initUI(self):
        ...
        voltar_inicio_button = QPushButton("Voltar ao Início", self)
        voltar_inicio_button.clicked.connect(self.abrir_tela_inicial)
        group_layout.addWidget(voltar_inicio_button, 0, 1)
    ...
    def abrir_tela_inicial(self):
        self.close()
        janela_primeira_tela = TelaInicial()
        janela_primeira_tela.show()
