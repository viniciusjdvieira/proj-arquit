...
class JanelaTerceiraTela(QDialog):
    ...
    def carregar_audio(self):
        ...
        if file_dialog.exec_():
            ...
            reproduzir_button.clicked.connect(lambda: self.reproduzir_audio(caminho_arquivo))
            ...
            # Criar um novo widget para exibir os botões e o player de áudio
            widget = QWidget()
            ...
            # Remover o layout anterior e adicionar o novo widget ao layout principal da terceira janela
            self.layout().removeItem(self.layout().itemAt(0))
            self.layout().addWidget(widget)


    def reproduzir_audio(self, caminho_arquivo):
        # Carregar o arquivo de áudio usando a biblioteca sounddevice
        audio, fs = sd.read(caminho_arquivo, dtype='float32')
